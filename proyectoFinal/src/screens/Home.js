  ...
  return (
    <ScrollView>
      ...
      <Text style={styles.paragraph}>
        El evento que reune a los mejores artista del mundo llega a Cali,
        preparate para vivir una experiencia única junto a los artistas que
        conoces y quieres ver.{"\n"}
        {"\n"}
        Acompañanos el 19 de Junio de 2022, en los alrededores del autocine en
